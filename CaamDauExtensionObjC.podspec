...
Pod::Spec.new do |s|
  s.name             = 'CaamDauExtensionObjC'
  s.version          = '1.0'
  s.summary          = 'CaamDau 系列产品：分类、扩展、链式 OC 版本.'
  s.description      = <<-DESC
  ...
  s.source           = { :git => 'https://github.com/CaamDau/ExtensionObjC.git', :tag => s.version }

  s.ios.deployment_target = '9.0'
  
  s.source_files = 'ExtensionObjC/ExtensionObjC.h',
   'ExtensionObjC/Chain/*.{h,m}', 
   'ExtensionObjC/Categories/*.{h,m}'
